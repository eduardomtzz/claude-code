...
function rodape(s, dark){
  s.addText('Kit IA no Trabalho · Essencial · modelo do Seu Sócio Gestor. Troque os textos; mantenha a estrutura.',{x:0.5,y:5.22,w:7.5,h:0.25,fontFace:H,fontSize:8,color:dark?LILC:LILAS,isTextBox:true,margin:0});
...
rodape(s,true);
s.addNotes('Capa. Troque mês, empresa, público e data. A frase em itálico é a conclusão do mês em uma linha: escreva por último.');
// 2 · Resumo do mês
...
s=pres.addSlide(); s.background={color:BR};
titulo(s,'Receita cresceu pelo terceiro mês seguido e passou a meta','Receita mensal (R$ mil) e meta. Fonte: planilha Relatório Mensal Pronto.');
s.addChart(pres.charts.BAR,[{name:'Receita',labels:['Abr','Mai','Jun','Jul','Ago','Set'],values:[109.8,118.3,121.9,115.7,124.6,131.2]}],
...
const cols=[['O que aconteceu','Despesas +3% em setembro e +6% acima da meta. Alimentação, transporte e educação subiram.'],['Causa provável','Curso de motion (R$ 297) e dois eventos com equipe. Parte é pontual, parte é reajuste de fornecedores.'],['Ação proposta','Congelar novas assinaturas até dezembro; renegociar dois fornecedores; revisar a meta para R$ 88 mil.']];
...
const acts=[['1','Renegociar dois fornecedores de alimentação e transporte','Ana · até 15/10'],['2','Ajustar público do anúncio e criar triagem de leads','Bruno · até 10/10'],['3','Revisar a meta de despesas e apresentar o novo orçamento','Ana · até 31/10']];
