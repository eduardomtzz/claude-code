...
// 7 exemplo real
s=slide(p); titulo(s,'Como funciona na prática: a parceria da Dra. Renata','Endocrinologia, dois turnos por semana (terça e quinta à tarde, Sala 1) desde janeiro de 2026. Números de produção e repasse, com autorização dela.');
...
[['R$ 10.380','Produção de agosto','30 avaliações endócrinas em 23,7 horas',1.6,false],['R$ 5.190','Repasse de agosto','pago em 10 de setembro, com demonstrativo',2.85,true]].forEach(k=>{
...
s.addText('Janeiro a agosto: R$ 74.830 de produção e R$ 37.415 de repasse, sempre no dia 10. A agenda dela está em 88 % de ocupação em setembro.',{x:5.9,y:4.1,w:3.6,h:0.85,fontFace:H,fontSize:10.5,color:C.TINTA,isTextBox:true,margin:0,valign:'top'});
s.addNotes('Exemplo real. Só com autorização do parceiro atual, e só produção, horas e repasse (planilhas 01 e 11). Nenhum paciente, nenhum dado clínico, nenhum número interno da clínica. Se não houver parceiro ainda, troque por uma simulação e diga que é simulação. Gráfico nativo: clique > Editar dados.');
