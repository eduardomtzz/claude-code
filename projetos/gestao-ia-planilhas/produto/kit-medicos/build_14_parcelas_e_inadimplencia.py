...
cfg.cell(row=RG1+4,column=1,value="Regra que vale mais que a régua: quem tem parcela vencida em aberto não combina novo parcelamento. O atendimento acontece normalmente; o que muda é a forma de pagamento, que passa a ser à vista (Pix, dinheiro ou cartão), combinada em particular e sem constrangimento. Atendimento nunca é condicionado a pagamento. No exemplo do kit, nenhum paciente com parcela vencida recebeu crédito novo, e o mesmo vale para orçamento aprovado a prazo (planilha 15).").font=F(size=9,color=LILAS)
