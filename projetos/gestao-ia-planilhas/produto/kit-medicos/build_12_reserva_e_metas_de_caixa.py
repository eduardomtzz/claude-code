...
cfg["D8"]="Três meses de custo fixo é a meta usual para uma clínica pequena: convênio atrasa, agenda esvazia em janeiro e julho, equipamento quebra."; nota(cfg["D8"])
...
cfg["D13"]="Copie de \"Para onde foi o dinheiro\" (Painel da planilha 09): aluguel, recepção, contador, sistema, energia, limpeza, marketing, anuidades e pró-labore fixo. Impostos, materiais, taxas de cartão e repasse ficam fora (variam com o movimento)."; nota(cfg["D13"]); cfg["D13"].alignment=Alignment(wrap_text=True,vertical="top"); cfg.merge_cells("D13:F15")
