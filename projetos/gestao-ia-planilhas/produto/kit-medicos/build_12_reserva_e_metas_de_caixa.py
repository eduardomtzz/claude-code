...
cfg["D13"]="Copie de \"Para onde foi o dinheiro\" (Painel da planilha 09), somando as oito linhas de custo fixo (aluguel, recepção, contador, sistema, energia, limpeza, marketing, anuidades) com a linha \"Pró-labore dos sócios\" inteira, como ela aparece lá. Impostos, materiais, taxas de cartão e repasse ficam fora (variam com o movimento). No exemplo: junho R$ 29.500 e julho R$ 31.591 vêm acima dos R$ 28.000 de agosto porque a linha de pró-labore da 09 traz também a retirada extra de 19/06 e a distribuição de lucro paga em 10/07 — a média fica um pouco acima do mês normal, e a meta de reserva sai mais conservadora. Se preferir dimensionar pelo mês normal, use os três meses sem retirada extra."; nota(cfg["D13"]); cfg["D13"].alignment=Alignment(wrap_text=True,vertical="top"); cfg.merge_cells("D13:F16")
