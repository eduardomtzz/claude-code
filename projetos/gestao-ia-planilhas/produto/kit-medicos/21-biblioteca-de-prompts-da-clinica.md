...
40 prompts em 5 grupos, um para cada núcleo do kit: Agenda, Preço, Caixa, Recebíveis e Painel.
...
Os prompts têm o número com que as planilhas os citam na aba "Como usar"; por isso o grupo Caixa
vai de 01 a 09 sem o 03 (são oito prompts, como nos outros grupos).

## De onde vem cada bloco

| Planilha do kit | Aba que você copia | Usada nos prompts |
|---|---|---|
| 1 Agenda e ocupação | Painel (tabelas por profissional, sala, dia e período; próximos 7 dias) | Agenda 01, 07, 08, Preço 08, Painel 07 |
| 2 Faltas e retornos | Painel (por dia, pagador, profissional; lista de retorno sem nomes) | Agenda 02, 03 |
...
| 9 Caixa da clínica | Painel ("Para onde foi", "De onde veio", "O ano mês a mês") | Caixa 01, 03, 06 |
| 10 Provisão de impostos, 13º e férias | Painel | Caixa 04, 05 |
| 11 Repasse e pró-labore | Painel ("Médicos parceiros", "Sócios no ano"), Retiradas | Caixa 06, 07, Painel 07 |
| 12 Reserva e metas de caixa | Painel | Caixa 08 |
| 13 Convênios a receber | Painel ("Por convênio", "Lotes em aberto", guias glosadas sem nomes) | Recebíveis 01, 03, 08 |
| 14 Parcelas e inadimplência | Painel ("Cobrar primeiro", sem nomes; a régua está em Config) | Recebíveis 02, 04, 06, 07 |
| 15 Orçamentos | Painel (funil, motivos de recusa, por tipo) | Agenda 04, Recebíveis 05, Preço 07 |
| 16 Conciliação de cartão | Painel ("Por tipo de pagamento") | Caixa 09 |
| 17 Painel da clínica | Painel | Painel 07, 08 |
| 18 Resultado mensal | Painel e Resultado (mês e mês anterior) | Caixa 02, Painel 02 |
| 19 Metas do trimestre | Metas ("Todos os resultados-chave") | Painel 05, 06 |
| 20 Resumo do mês | Resumo ("Bloco único para copiar") | Painel 01, 02, 03, 04, Caixa 04 |
...
recepção; lote de convênio dia 5; a rotina de exemplo do kit (4 passos de segunda com a recepção, 5
de sexta; a mais pulada é "ligar para a lista de retorno", feita em 1 de 4 semanas). Saída: segunda
com 4 passos em 12 minutos (vagas dos próximos 7 dias, confirmações da semana, lista de retorno,
faltas da semana passada) e sexta com 5 passos em 18 minutos (fechamentos do dia no caixa, parcelas e
cobrança, guias e lotes, orçamentos, painel com 3 decisões); a conciliação do cartão ficou para a
sexta seguinte, alternando.
**Confira:** se a soma dos minutos bate e se a IA não inventou uma planilha que o kit não tem. A
rotina só funciona se a lista de retorno tiver dono: no exemplo, foi a rotina mais pulada.
...
[cole aqui]
```
**Exemplo:** Entrada: os 23 dias com pendência da Vida Plena (52 dias registrados de 01/07 a 11/09;
abertura completa em 85 % dos últimos 20 dias, fechamento em 55 %; 31 itens pendentes; o mais
esquecido: "Caixa do dia fechado e conferido (Pix, cartão, dinheiro)"; depois "Fechamento do dia
lançado no Caixa (09)" e "Guias do dia conferidas e guardadas para o lote"). Saída: quatro tarefas
("fechar e conferir o caixa antes de desligar a maquininha", "lançar o fechamento no Caixa (09) com a
planilha aberta na tela", "guias na pasta do lote ao fim de cada turno", "retornos agendados na saída
do paciente"), o momento de cada uma e a sugestão: imprimir o checklist de fechamento (bônus 25) e
deixar ao lado do computador da recepção.
**Confira:** o que é de fato responsabilidade da recepção e o que o sócio precisa fazer (o Caixa 09
do exemplo é lançado pela Dra. Carolina na sexta).

### Agenda 07 · Pauta da reunião de segunda com a recepção
**Quando usar:** para a conversa de 10 minutos de segunda entre o sócio da semana e a recepção, com
...
Saída: pauta de cinco itens em 10 minutos, com o item 3 marcado como "confirmar os 19 de quinta até
...
%), feriado na segunda 07/09; R$ 21.570 entrados em setembro até sexta; lote de julho da Saúde Total
pago em 08/09 (R$ 5.780, glosa R$ 170) e os três lotes de agosto enviados em 08/09 (R$ 9.631); lote de
junho da Vida Care atrasado desde 04/09 (R$ 1.727); 16 parcelas vencidas (R$ 4.550); 4 orçamentos
aprovados na sexta (R$ 1.400); a rotina "ligar para a lista de retorno" não foi feita. Saída: os
quatro blocos, causa provável do que travou ("a semana curta comeu a segunda, e a lista de retorno
depende da segunda"), ajuste "mover a lista de retorno para a terça em semana de feriado" e a
mensagem pronta para o sócio.
...
11 tabelas de convênio abaixo do custo. Saída: "o ECG é o único procedimento com valor médio abaixo do
mínimo, e é o mix: 13 dos 18 foram por convênio a R$ 32 a R$ 40"; consulta a +7 % porque 48 % das 130
...
5 % no Pix; não posso baixar de R$ 400. Saída: cálculo (20 % de desconto leva a R$ 360, abaixo do
piso que a clínica definiu; 5 % no Pix leva a R$ 427,50 com margem de 51 %; 3 vezes no cartão custa
R$ 17,55 de taxa) e resposta de 90 palavras com as duas alternativas.
...
convênio parecido (MediPlan): R$ 77,55 por consulta; caixa livre R$ 26.254; reserva R$ 14.000; custo
...
```
**Exemplo:** Entrada: o Painel de agosto da Vida Plena (Config = Agosto): entrou R$ 50.336 (particular
à vista R$ 33.860, particular a prazo R$ 5.315, Saúde Total R$ 7.320, MediPlan R$ 2.130, Vida Care
R$ 1.711), saiu R$ 41.620 (pró-labore R$ 18.000, custos fixos R$ 10.000, guia de impostos R$ 5.841,
repasse à Dra. Renata R$ 4.845, materiais R$ 1.380, taxas de cartão R$ 484, manutenção R$ 450,
despesa pessoal a acertar R$ 620), sobrou R$ 8.716, saldo R$ 44.311; julho: entrou R$ 53.101 e sobrou
R$ 9.674. Contexto: "julho teve a distribuição do 2º trimestre e agosto teve manutenção do
...
[cole]
```
**Exemplo:** Entrada: julho e agosto da Vida Plena na Planilha 18 (receita R$ 53.101 para R$ 50.336;
despesas variáveis R$ 6.662 para R$ 7.159; total de saídas R$ 40.503 para R$ 40.696; resultado
R$ 12.598 para R$ 9.640; margem 23,7 % para 19,2 %). Saída: tabela com as linhas, receita −5,2 %
(piorou), custos fixos estável, variáveis +7,5 % (piorou: manutenção de R$ 450 e repasse maior),
resultado −23,5 % (piorou), margem −4,5 p.p. e a conclusão: "a queda é de receita particular à vista
(R$ 36.540 para R$ 33.860), não de custo; os convênios até subiram".
...
```
**Exemplo:** Entrada: o Resumo de agosto da Vida Plena (receita R$ 50.336, saídas R$ 40.696, resultado
R$ 9.640, margem 19,2 %; provisão acumulada na Planilha 10 R$ 17.602 ao fim de agosto e guia de
20/09 prevista em R$ 5.537; repasse à Dra. Renata R$ 5.190 pago em 10/09; R$ 5.440 a acertar com os
...
[cole aqui]
```
**Exemplo:** Entrada: setembro da Vida Plena até 11/09: entradas R$ 21.570, alíquota 11 %, provisão
R$ 2.373, mais R$ 1.698 de 13º (R$ 750 de cada sócio, decididos pelos sócios, e R$ 198 da
recepcionista) e R$ 264 de férias (R$ 4.335 a separar no mês); saldo provisionado R$ 21.937;
compromisso do mês seguinte R$ 2.373; guia de agosto (R$ 5.537) vence em 20/09. Saída: conta
...
[cole aqui]
```
**Exemplo:** Entrada: 48 lançamentos de junho da conta da Vida Plena, descrição resumida. Saída:
tabela classificada, 5 linhas em "Não sei" (farmácia, posto, restaurante), retirada extra de
R$ 1.500 da Dra. Carolina em 19/06 além do pró-labore de R$ 9.000 (a lançar na Planilha 11 como
retirada extra) e dois lançamentos pessoais pagos pela clínica (R$ 620, a acertar).
...
```
**Exemplo:** Entrada: custo fixo mensal R$ 28.000 com pró-labore (meta de 3 meses: R$ 84.000),
reserva R$ 14.000, sobra média dos últimos 3 meses R$ 8.777 (junho R$ 2.321, julho R$ 9.674, agosto
R$ 8.716), sem entrada extraordinária certa; janeiro e fevereiro fecharam negativos. Saída: faltam
R$ 70.000; conservador R$ 3.000 por mês (24 meses: setembro de 2028, como na Planilha 12), provável
R$ 5.000 (14 meses), ambicioso R$ 7.000 (10 meses); regra: "a reserva paga custo fixo e repasse em
mês fraco; não paga equipamento nem retirada extra"; entrada extraordinária: 50 % para a reserva até
a meta.
**Confira:** a sobra média (que a planilha calcula) e se o ritmo cabe no pró-labore combinado. O
...
R$ 10.899; consulta particular R$ 380. Saída: "R$ 484 no mês equivalem a 1,3 consultas; no ano, cerca
...
glosa"; o MediPlan pesa mais no caixa (R$ 6.305 presos a 47 dias); vence em 30 dias R$ 4.602; perguntas:
...
[cole aqui]
```
**Exemplo:** Entrada: as 16 parcelas vencidas da Vida Plena em 14/09 (R$ 4.550): 11 com 30 dias ou
mais (R$ 3.190; entre elas Paciente A, avaliação endócrina, R$ 400, 158 dias; Paciente B, consulta,
R$ 380, 130 dias; Paciente C, R$ 200, 214 dias), 1 entre 15 e 29 dias (R$ 450), 2 entre 7 e 14
(R$ 590), 2 entre 1 e 6 (R$ 320, nunca atrasaram). Saída: os 11 antigos como prioridade 1 no degrau
30 (conversa e plano por escrito), as 2 de 1 a 6 dias como prioridade 2 no degrau 1 (lembrete leve,
primeiro atraso), a de 15 a 29 como prioridade 2 no degrau 15 (ligação com demonstrativo); e a
observação: "R$ 3.190 estão há mais de 30 dias: mensagem já não resolve; agende as conversas".
...
[cole aqui]
```
**Exemplo:** Entrada: os 32 orçamentos da Vida Plena desde julho: 21 aprovados (R$ 8.510), 5
recusados (R$ 1.860), 3 sem retorno (R$ 1.660), 6 em aberto (R$ 3.460); taxa de aprovação 72 %; exames
cardiológicos 83 % (20 de 24 decididos), pacotes de consultas 0 de 2 e avaliação endócrina 0 de 1;
motivos: "vai pensar / sem retorno" 3 (R$ 1.660), preço 2 (R$ 680), fez em outro lugar 1, vai fazer
pelo convênio 1, sem indicação no momento 1; 6 dias em média até decidir. Saída: aprovação alta em
...
```
**Exemplo:** Entrada: o bloco único de agosto da Planilha 20 da Clínica Vida Plena (entrou R$ 50.336,
saiu R$ 40.696, resultado R$ 9.640 e margem 19,2 %; ocupação 70,4 % e 118,3 horas atendidas; taxa de
falta 8,4 %; convênio a receber R$ 12.077 e glosa dos lotes pagos no mês 5,6 %; vencido R$ 4.040 e
inadimplência a prazo 9,8 %; orçamentos em aberto R$ 1.730); comentário: "a Dra. Renata teve dois
turnos com falta em sequência; o MediPlan glosou três guias de consulta por código de procedimento
errado; o Vida Care pagou o lote de julho; o repasse da Renata saiu no dia 10". Saída: texto de 240
palavras com um "[explicar]" na agenda (o bloco da 20 não traz ocupação por sala: acrescente a da
Planilha 1 à mão) e a decisão: "recorrer das três glosas do MediPlan até o dia 20 e confirmar por
mensagem, na véspera, os retornos da terça de manhã".
...
R$ 9.640 (julho: R$ 12.598), destaques (receita 9,4 % acima do previsto; convênios pagos R$ 11.161, os
três maiores do ano; taxa de falta caiu para 8,4 %), atenções (margem −4,5 p.p.; vencido R$ 4.040 e
inadimplência 9,8 % acima da meta de 8 %; ocupação 70,4 % contra meta de 75 %; um "[explicar]" na
...
de 23,7 % para 19,2 % se os convênios pagaram mais?", "quanto do a receber dos convênios vai virar
...
```
**Exemplo:** Entrada: receita de março a agosto (R$ 47.880, 39.590, 44.760, 43.855, 53.101, 50.336),
resultado, ocupação de julho e agosto (71,7 % e 70,4 %), taxa de falta (8,8 % e 8,4 %), glosa dos lotes
pagos no mês (4,3 % e 5,6 %), inadimplência (9,6 % e 9,8 %), 6 orçamentos abertos somando R$ 3.460.
...
taxa de falta 7,1 % (meta 5 %); lista de retorno 7 (meta 8, no ritmo); glosa no ano 5,5 % (meta 4 %);
prazo real dos lotes 44 dias (meta 40); glosa recuperada R$ 200 (meta R$ 1.000); inadimplência 10,4 %
(meta 8 %); reserva R$ 14.000 (meta R$ 17.000); conta de provisão R$ 17.500 (meta R$ 21.937). Saída:
6 em risco, 2 em atenção, 1 no ritmo; os dois mais atrás (ocupação, que caiu em vez de subir; glosa
...
R$ 5.190 em agosto por 23,7 horas e a margem da parceria no ano é R$ 25.740; caixa livre R$ 26.254;
reserva R$ 14.000; vencido R$ 4.550. Saída: os dados sustentam que há sala e recepção ociosas nas
tardes de segunda e quarta; não respondem se há demanda; custo da decisão perto de zero fixo (repasse
é variável), mas o novo turno precisa de cerca de R$ 1.150 de produção por mês só para pagar a
estrutura das 16 horas; versão reversível: um turno por três meses, com data de revisão.
