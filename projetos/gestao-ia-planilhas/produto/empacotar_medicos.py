#!/usr/bin/env python3
"""Monta kit-medicos/entrega/ (planilhas 01-20, PDFs 21-26 + txt, modelos 27-29, LEIA-ME, videos/) e o zip."""
import pathlib, shutil, subprocess, zipfile, sys
ROOT=pathlib.Path(__file__).resolve().parent/'kit-medicos'; E=ROOT/'entrega'; E.mkdir(exist_ok=True)
...
if '--zip' in sys.argv:
    zipf=ROOT/'kit-de-gestao-para-medicos-v1.zip'
