...
def build(md_path, pdf_name, titulo, sub, capa=True):
    ...
    return out
jobs=[build('14-manual-do-metodo.md','14-manual-do-metodo','Manual do método: <em>estruturar, preencher, perguntar, entregar</em>','As 10 planilhas, os 80 prompts, as 8 aulas e a rotina da semana, do mês e do trimestre. Leia uma vez; depois é só rotina.'),
      ...
      build('12-dicionario-de-formulas.md','12-dicionario-de-formulas','60 fórmulas <em>em uma frase</em>','Português e inglês, o que faz e um exemplo pronto. Para ter ao lado enquanto monta a sua planilha.'),
      build('13-checklists-de-revisao.md','13-checklists-de-revisao','Checklists','',capa=False)]
