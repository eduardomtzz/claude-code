...
![Painel do Relatório Mensal Pronto](docs/tela-relatorio-painel.png)
...
![Painel de Projetos e Prazos](docs/tela-projetos-painel.png)

![Linha do tempo por semanas](docs/tela-projetos-linha.png)
...
![Pendências em aberto](docs/tela-ata-aberto.png)

![Resumo da reunião, pronto para a IA](docs/tela-ata-resumo.png)
...
![Painel de Metas do Trimestre](docs/tela-metas-painel.png)
...
![Painel do Orçamento](docs/tela-orcamento-painel.png)
...
![Painel do Funil de Propostas](docs/tela-funil-painel.png)
...
![Painel de Horas e Custo](docs/tela-horas-painel.png)
...
![Checklist de limpeza](docs/tela-base-checklist.png)
