...
como_usar(wb,"Metas do Trimestre",[
 ...
 ("Passo 1","Em Config, preencha o trimestre, as datas de início e fim, troque a data de referência por =HOJE() (no exemplo ela está congelada em 14/09/2026) e liste as pessoas do escritório (de cima para baixo, sem pular linha)."),
