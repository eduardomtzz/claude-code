...
(cinco núcleos, um fechamento por semana), organiza a implantação em quatro semanas, mostra o que
cada uma das 20 planilhas faz, ensina a usar a IA sem expor cliente nem processo e fecha com a
rotina de segunda, de sexta, do dia 5 e do fim do trimestre. As 8 aulas em vídeo mostram tudo isso
na tela; o manual é o mapa.
...
|---|---|---|
| 01 a 04 | Núcleo Prazos: Agenda de prazos e audiências, Andamento por processo, Rotina da semana, Checklist de abertura e encerramento | 15 min na segunda |
| 05 a 08 | Núcleo Honorários: Custo-hora, Simulador de honorários, Proposta de honorários, Tabela de referência | 10 min por proposta; revisão trimestral |
| 09 a 12 | Núcleo Caixa: Caixa do escritório, Provisão de impostos, 13º e férias, Pró-labore e separação PF × escritório, Reserva e metas de caixa | 15 min na sexta; 1 hora no dia 5 |
| 13 a 16 | Núcleo Carteira: Carteira de clientes e casos, Parcelas e inadimplência, Funil de propostas, Horas por caso e por pessoa | 10 min na sexta; 2 min por dia para as horas |
| 17 a 20 | Núcleo Painel: Painel do escritório, Resultado mensal, Metas do trimestre, Resumo do mês para a IA e para o contador | 10 min na sexta; 30 min no dia 5 |
...
Abre tudo no Excel 2019 ou mais novo, no Microsoft 365 e no Google Sheets. As planilhas 01, 02,
03, 04 e 13 usam MÍNIMOSES, MÁXIMOSES e UNIRTEXTO, funções que o Excel 2016 e anteriores não têm
(nelas, o Excel antigo mostra "#NOME?" em algumas colunas). As outras 15 abrem em qualquer Excel a
partir de 2007. No celular, os aplicativos abrem e mostram; para preencher, use o computador. Sem
macros, sem instalação, sem login, sem mensalidade.

Todas as planilhas vêm preenchidas com o mesmo escritório fictício, Ferraz & Lima Advocacia: dois
sócios, uma estagiária, 18 clientes, 38 casos, setembro de 2026. Clientes, processos e valores são
inventados; os números de processo seguem o formato do CNJ, mas não existem. As datas de prazo do
exemplo são relativas a hoje (fórmula), por isso o exemplo não envelhece. Você apaga o exemplo e
digita o seu.
...
pró-labore ÷ horas faturáveis) × horas estimadas do caso + margem = proposta. Antes de mandar,
compara com o que o escritório já cobra.
...
**Um fechamento por semana, em dois momentos.** Segunda-feira, 15 minutos: prazos (resolver ou
reagendar os atrasados, confirmar a semana com cada responsável, atualizar o andamento).
Sexta-feira, 15 minutos: caixa e painel (lançar o que entrou e saiu, marcar parcelas, registrar as
horas, atualizar o Painel do escritório). A planilha 03 registra se a rotina foi feita; o que não
vira hábito em quatro semanas é encurtado, não abandonado.
...
**Quem alimenta quem.** Sem link entre arquivos, esta é a ordem natural de copiar:

| De | Para | O que copiar |
|---|---|---|
| 05 Custo-hora | 06, 08, 16 | Custo-hora, hora mínima, custos fixos sem a equipe |
| 13 Carteira | 14, 16 | A lista de casos (número, cliente, modalidade, valor) |
| 09 Caixa | 10, 11, 12, 18 | Entradas do mês, saídas, saldo, custo fixo |
| 01, 09, 13, 14, 15, 16 | 17 Painel | Os 14 totais de sexta |
...
Não abra as vinte de uma vez. Um núcleo por semana, começando pelo que dói mais (prazo) e pelo
número que muda tudo (custo-hora). Assista à aula 1 antes da semana 1. Para apagar o exemplo,
...
### Semana 1 · Prazos e custo-hora (planilhas 01, 02, 03, 05) · 2 horas

**Abrir:** 01 Agenda de prazos, 02 Andamento, 05 Custo-hora, 03 Rotina. Aulas 2 e 3.
**Apagar:** as abas Prazos, Processos, Custos fixos e Pessoas.
**Digitar:** na 01, todos os prazos, audiências e compromissos dos próximos 60 dias, com
responsável. Na 02, todos os casos ativos com fase, próxima ação e data. Na 05, os custos fixos do
mês e as pessoas com pró-labore ou salário, horas de trabalho e horas faturáveis. Na 03, as linhas
da rotina de segunda e de sexta com responsável.
**Tempo:** 60 a 90 minutos para prazos e casos (o maior esforço da implantação; depois é
manutenção), 20 para o custo-hora, 10 para a rotina.
**Sai sabendo:** o que vence primeiro, quais casos estão parados e quanto custa uma hora do seu
escritório. Anote o custo-hora e a hora mínima: as planilhas 06, 08 e 16 pedem.

### Semana 2 · Honorários e caixa (planilhas 06, 07, 08, 09, 10) · 2 horas

**Abrir:** 06 Simulador, 07 Proposta, 08 Tabela de referência, 09 Caixa, 10 Provisão. Aulas 4 e 5.
...
típicas de cada serviço que o escritório faz. Na 09, o saldo antes do primeiro lançamento e todo
movimento do mês atual (o extrato do dia 1 até hoje resolve). Na 10, a alíquota efetiva que o
contador informar e as entradas dos meses já fechados.
**Tempo:** 30 minutos para os honorários, 60 para o caixa, 20 para a provisão.
...
### Semana 3 · Carteira (planilhas 11, 12, 13, 14, 15, 16) · 2 horas

**Abrir:** 13 Carteira, 14 Parcelas, 16 Horas, 15 Funil, depois 11 Pró-labore e 12 Reserva. Aula 6.
...
com dinheiro). Copie a lista de casos da 13 para a aba Casos da 14 e da 16. Na 14, as parcelas
combinadas, marcando as pagas. Na 16, as horas estimadas e, daqui em diante, o lançamento diário.
Na 15, as propostas em aberto. Na 11, os sócios e os movimentos do mês; na 12, o custo fixo dos
últimos três meses, o saldo e o aporte que cabe.
...
**Abrir:** 17 Painel do escritório, 18 Resultado mensal, 19 Metas, 20 Resumo do mês. Aulas 7 e 8.
...
**Digitar:** na 17, o limite de cada indicador (0 prazos atrasados, 70% de horas faturáveis,
inadimplência de 10%, por exemplo) e, na sexta, os totais das planilhas 01, 16, 09, 13, 14 e 15.
Na 18, os meses já fechados do ano e o previsto. Na 19, até 3 objetivos com até 3 resultados-chave.
Na 20, os 12 indicadores com meta, mês anterior e mês atual.
...
### 4.1 Agenda de prazos e audiências (arquivo 01)
...
**Sai:** atrasados, hoje, abertos e feitos; "O que vence primeiro"; carga por responsável; os
próximos 7 dias, dia a dia.
**Prompt:** Prazos 01 (priorizar pela carga), Prazos 03 (atrasados em comum), Prazos 04 (distribuir).

![Painel da Agenda de prazos](docs/tela-01.png)
...
**Sai:** ativos, ação atrasada, ação nesta semana, sem próxima ação, encerrados; por fase e por
responsável; os 12 casos parados há mais tempo.
**Prompt:** Prazos 05 (resumo de andamento para o sócio), Prazos 07 (pendências viram tarefas).

![Painel do Andamento por processo](docs/tela-02.png)
...
![Painel da Rotina da semana](docs/tela-03.png)

**Detalhe que importa:** o exemplo soma 30 minutos por semana (segunda 12, sexta 18). Abaixo de 70%
fica vermelho. A rotina mais pulada merece ser encurtada, delegada ou trocada de dia, não bronca.
...
![Painel do Checklist de abertura e encerramento](docs/tela-04.png)
...
caso. "O que falta" usa UNIRTEXTO (Excel 2019+).
...
![Painel do Custo-hora](docs/tela-05.png)

**Detalhe que importa:** hora mínima = custo-hora ÷ (1 − margem − impostos), em múltiplos de R$ 5.
...
![Simulador de honorários](docs/tela-06.png)

**Detalhe que importa:** a recomendação é a maior margem entre as modalidades de risco aceitável.
Êxito puro vira risco alto com chance abaixo de 60% (Config); fixo, com folga de horas menor que
20%. A chance de êxito é a sua estimativa de gestão, não uma avaliação que a planilha faça.
...
![Proposta de honorários](docs/tela-07.png)

**Detalhe que importa:** os valores vêm do Simulador (06). A proposta não substitui o contrato de
honorários do escritório. Antes de enviar, o checklist do arquivo 25: nenhum número interno
(custo-hora, margem) vai no arquivo do cliente.
...
![Tabela de referência](docs/tela-08.png)

**Detalhe que importa:** mínimo = horas "de" × hora mínima; máximo = horas "até" × hora alvo.
Abaixo do mínimo, o caso paga o custo, mas não a margem. Os valores são do seu escritório, calculados
do seu custo; não é tabela oficial de nenhuma entidade.
...
![Painel do Caixa do escritório](docs/tela-09.png)

**Detalhe que importa:** só Pago? = Sim conta como caixa; honorário faturado e não recebido entra
com Não e vira Sim quando cair. É a planilha que alimenta a 10, a 11, a 12 e a 18.
...
![Painel da Provisão de impostos](docs/tela-10.png)

**Detalhe que importa:** provisão = entradas × alíquota efetiva. A planilha separa dinheiro; não
apura imposto e não afirma qual é a sua alíquota: isso vem do contador (bônus 24). Compare o saldo
...
![Painel do Pró-labore](docs/tela-11.png)

**Detalhe que importa:** fora do combinado = retiradas extras + despesas pessoais pagas pelo
escritório − devoluções; a distribuição segue a regra e só sai de trimestre fechado. O formato
tributário de cada retirada se combina com o contador.
...
![Painel da Reserva e metas de caixa](docs/tela-12.png)

**Detalhe que importa:** a projeção supõe aporte igual todo mês, sem rendimento. Quando a reserva
...
![Painel da Carteira de clientes e casos](docs/tela-13.png)

**Detalhe que importa:** o cliente vem antes do caso (Clientes alimenta a lista de Casos). A lista
de casos daqui é copiada para a aba Casos das 14 e 16: mantenha o número escrito igual nas três.
"Último caso aberto" usa MÁXIMOSES (Excel 2019+).
...
![Painel de Parcelas e inadimplência](docs/tela-14.png)

**Detalhe que importa:** inadimplência = vencido ÷ tudo o que já venceu. A régua do exemplo tem
quatro degraus (1, 7, 15 e 30 dias), em ordem crescente e sem ameaça; as mensagens estão no bônus
22. "Cobrar primeiro" ordena por valor × dias de atraso. A conversa com o cliente é sua.
...
![Painel do Funil de propostas](docs/tela-15.png)

**Detalhe que importa:** previsão ponderada = valor × probabilidade da etapa (contato 10%, reunião
25%, proposta enviada 50%, negociação 75%). O motivo da perda é a parte mais valiosa da planilha.
Proposta fechada vira caso na 13 e parcelas na 14.
...
![Painel de Horas por caso](docs/tela-16.png)

**Detalhe que importa:** custo-hora da pessoa = custo mensal ÷ horas faturáveis + rateio do custo
fixo. "Consome mais do que paga" = custo das horas maior que o contratado; "Perto do limite" = mais
de 85% das horas estimadas. Dois minutos no fim do dia; horas lançadas de memória saem erradas.
...
![Painel do escritório](docs/tela-17.png)

**Detalhe que importa:** é a planilha mais simples do kit de propósito: 14 números copiados à mão em
10 minutos. Linha sem limite fica "Informativo". Fora do alvo primeiro: atrasados e vencido pedem
ação na segunda (01 e 14).
...
![Painel do Resultado mensal](docs/tela-18.png)

**Detalhe que importa:** DRE simplificada por regime de caixa: entra o recebido, sai o pago, e os
impostos entram como % da receita para o resultado não parecer maior do que é. Meses futuros ficam em
branco. A alíquota é a mesma da planilha 10, dada pelo contador.
...
![Painel das Metas do trimestre](docs/tela-19.png)
...
![Aba Resumo do Resumo do mês](docs/tela-20.png)

![Painel do Resumo do mês](docs/tela-20-painel.png)

**Detalhe que importa:** o bloco só tem totais do escritório, sem cliente nem processo: é o único
texto do kit pronto para colar na IA sem tratamento. Em %, digite 16,8 e não 0,168. Todo mês, mova
"Mês atual" para "Mês anterior". A observação do escritório é o porquê dos números.
...
**Segunda, 15 minutos (prazos).** Agenda (01): resolver ou reagendar os atrasados, confirmar com cada
...
**Sexta, 15 minutos (caixa e painel).** Caixa (09): lançar a semana, marcar Sim no que caiu. Horas
...
**Antes de cada proposta, 15 minutos.** Tabela de referência (08) para a faixa; Simulador (06) para
a modalidade; Proposta (07) para o documento; Honorários 02 para revisar pela margem; checklist
"Antes de enviar a proposta" (25); linha no Funil (15).
...
| "#NOME?" em uma coluna | Excel 2016 ou anterior sem MÍNIMOSES, MÁXIMOSES ou UNIRTEXTO (planilhas 01, 02, 03, 04 e 13) | Use Excel 2019+, Microsoft 365 ou Google Sheets |
...
| Percentual estranho no Resumo do mês | Digitou 0,168 em vez de 16,8 | Em Indicadores, percentuais são digitados como 16,8 |
