...
CFG['medicos']=dict(
  cenas=[
   ...
   {'tipo':'prova','fala':'Não é promessa: vinte planilhas reais, quarenta e um prompts, oito aulas curtas e três modelos de apresentação. Tela real, clínica de exemplo.','min':7.0,'selos':['20 planilhas prontas','41 prompts','8 aulas curtas','3 modelos de slides']},
   ...
   {'tipo':'fim','fala':'Kit de Gestão para Médicos. Seiscentos e noventa e sete reais. Sete dias para desistir. Comece hoje.','min':6.0,'tt':'Kit de Gestão <em>para Médicos</em>','preco':'Comprar por R$ 697','nota':'20 planilhas · 41 prompts · 8 aulas · 3 modelos<br>Pix ou 12× · acesso imediato · 7 dias para desistir'},
  ])
